    ...
    <v-card>
        ...
        <v-card-text>
            <v-layout row>
                <v-autocomplete
                        v-model="specie"
                        label="Wpisz gatunek pupila"
                        :items="species"
                        @change="setBreeds">
                </v-autocomplete>
            </v-layout>
            <v-layout row>
                <v-select v-model="breed" :items="currentBreeds" :disabled="specie === ''"
                          label="Wpisz gatunek/rasę zwierzęcia">
                </v-select>
            </v-layout>
            <v-layout row>
                <v-flex xs12 md4>
                ...
                <v-flex xs12 md4>
                    ...
                    <v-radio-group>
                        <v-radio v-for="el in colors" :label="`${el}`"
                                 :value="el">
                        </v-radio>
                    </v-radio-group>
                </v-flex>
                <v-flex xs12 md4>
                    ...
                    <v-text-field v-model="age" :error-messages="ageErrors" @blur="$v.age.$touch()"
                                  @input="$v.age.$touch()">
                    </v-text-field>
                </v-flex>
